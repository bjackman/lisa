...
class LisaTest(unittest.TestCase):
    ...
    def _runExperiments(cls):
        ...
        cls.experiments_conf = cls._getExperimentsConf(test_env)
        cls.executor = Executor(test_env, cls.experiments_conf)
    ...
    def get_trace(self, experiment):
        ...
        if ("ftrace" not in experiment.conf["flags"]
            ...
            raise ValueError("get_trace only supported when ftrace enabled")
